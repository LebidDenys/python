...
class RectangularRoom(object):
    ...
    def getNumCleanedTiles(self):
        ...
        returns: an integer
        """
        cleaned_tiles = [value for value in self.tilesList.values() if value =='clean']
    ...
    def isPositionInRoom(self, pos):
        ...
        """
        return True if (int(math.floor(pos.x)), int(math.floor(pos.y))) in self.tilesList.keys() else False
